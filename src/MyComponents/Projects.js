...
const Projects = () => {
    return (
        <>
            ...
            {/* project div  */}
            <div class="min-w-screen min-h-screen mt-4 flex items-center   lg:p-10 overflow-hidden relative">
                <div class="card-2 w-full max-w-6xl rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
                    <div className="card-content">
                        <div class="md:flex items-center mx-10" style={divstyle} >
                            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                <div class="relative">
                                    <img src={require("./assets/proimg1.png")} style={styleimg} class="w-full relative z-10" alt="" />
                            ...
                            <div class="w-full md:w-1/2 px-10">
                                <div class="mb-10">
                                    <div className="flex">
                                        <h1 class="font-bold uppercase text-2xl mb-5">NETFLIX-CLONE </h1>
                                        <p className='space-x-2'>
                                            <a href='https://bquh2t-3000.csb.app/'  > <lord-icon
                                ...
                                <div>
                                    ...
                                    <a href="https://github.com/siddanth-6365/netflix_clone_basic" target="_blank" class="transition-transform transform hover:scale-125">
                        ...
                        <div class="md:flex items-center -mx-10" style={divstyle}>
                            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                                <div class="relative">
                                    <img src={require("./assets/pro2.png")} style={styleimg2} class="w-full relative z-10" alt="" />
                                </div>
                            </div>
                            <div class="w-full md:w-1/2 px-10">
                                <div class="mb-10">
                                    <div className="flex">
                                        ...
                                        <p className='space-x-2'>
                                            <a href='https://siddanth-6365.github.io/Todo-List_react/'  > <lord-icon
                                                src="https://cdn.lordicon.com/uvqnvwbl.json"
                                                trigger="loop"
                                                style={iconstyle}>
                                            </lord-icon></a>
